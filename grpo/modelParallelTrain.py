# CUDA_VISIBLE_DEVICES=5 trl vllm-serve --host 127.0.0.1 --model "Qwen3-32B" --port 8001 --max_model_len 2048
# CUDA_VISIBLE_DEVICES=0,1,2,6 accelerate launch --config_file zero3.yaml modelParallelTrain.py
'''
  offload_optimizer_device: cpu
  offload_param_device: cpu
will cause 1h stuck after  Time to load cpu_adam op: 2.623319625854492 seconds   
during 1h, training gpu mem will increase from 0 to 60+gb very slowly, i didn't see if it went to 80gb. when sending ctrl c it says oom and utilizing all 78gb.
rank1]:   File "/opt/miniconda3/envs/qwen3/lib/python3.10/site-packages/deepspeed/runtime/zero/partition_parameters.py", line 1576, in _all_gather 

 [rank1]:     self._allgather_params_coalesced(all_gather_nonquantize_list, hierarchy, quantize=False) 

 [rank1]:   File "/opt/miniconda3/envs/qwen3/lib/python3.10/site-packages/deepspeed/runtime/zero/partition_parameters.py", line 1865, in _allgather_params_coalesced 
...
output_dir = "./outputs/grpo8_connect4_qwen32b_strict_reformat"
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    # quantization_config=quantization_config, # can't train with quantization_config
)
